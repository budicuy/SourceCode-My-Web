...
<div class="flex">
 <aside class="w-64" aria-label="Sidebar">
  <div class="px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
   <ul class="space-y-2">
    <li id="menu-section-1" class="cursor-pointer">
     <span
    ...
    <li id="menu-section-2" class="cursor-pointer">
     <span
      class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
      <svg aria-hidden="true"
    ...
    <li id="menu-section-3" class="cursor-pointer">
     <span
      class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
      <svg aria-hidden="true"
       class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
 ...
 <main>
  <section id="section-1" class="halaman active">
   <h1 class="mt-5 ml-5 text-2xl font-bold">Dasboard</h1>
  </section>
  <section id="section-2" class="halaman">
   <h1 class="mt-5 ml-5 text-2xl font-bold">Kanban</h1>
  </section>
  <section id="section-3" class="halaman">
   <h1 class="mt-5 ml-5 text-2xl font-bold">User</h1>
  </section>
