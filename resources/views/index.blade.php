    ...
    <div class="container grid gap-0 px-2 md:px-0 hero lg:grid-cols-2 md:mt-0 ">
        <div class="flex items-center justify-center w-full h-full px-3 mt-5 lg:mt-0">
            <div class="relative">
                ...
                <div
                    class="inline-flex items-center gap-3 py-2 pl-2 pr-6 my-5 bg-purple-500 rounded-full neumorphism-shadow-1">
                    <img src="img/me.jpg" alt=""
                        class="w-12 h-12 border-2 border-white rounded-full shadow md:w-16 md:h-16">
    ...
    <div class="container py-20">
        <div class="mx-auto">
            <div class="flex flex-col items-center justify-center">
                ...
                <h1 class="px-5 text-3xl font-bold text-center text-purple-600 lg:text-5xl mb-7 md:px-0">The Benefit
                    Form My
                    Service
                </h1>
            </div>
    ...
    <div class="container">
        <div class="px-5 lg:px-20">
            ...
            <div class="grid grid-cols-1 gap-5 mb-10 md:grid-cols-3">
                <?php $i = 100; ?>
                @foreach ($projects_home as $project)
                <div data-aos="fade-up" data-aos-delay="{{ $i }}"
                    ...
                    <div>
                        ...
                        <h5 class="text-xl font-semibold lg:text-2xl text-black/90">
                            {!! Str::limit($project->tittle, 45, '<span
        ...
        <div class="container">
            <div class="px-5 md:px-10 lg:px-20">
                ...
                <div class="grid grid-cols-2 gap-5 mb-10 lg:grid-cols-3">
                    ...
                    <div data-aos="fade-up" data-aos-delay="{{ $i }}"
                        class="flex flex-col flex-wrap justify-between p-4 bg-white border rounded-lg shadow-lg">
                        <div>
                            <img loading="lazy" class="w-full rounded-lg " src="{{ $design->image }}"
                                alt="{{ $design->tittle }}">
                            <span class="flex gap-5 mt-3 font-semibold">
                                <u class="no-underline">#{{ $design->category->category_name }}</u>
                            </span>
                            <h3 class="text-xl font-semibold lg:text-2xl text-black/90">
                                {{-- jika lebih dari 100 karakter maka akan di potong dan ditambahkan tiga titik --}}
                                {!! Str::limit($design->tittle, 30, '<span
                                    class="font-normal text text-slate-400">...</span>') !!}
                            </h3>
            ...
            <a href="/design" class="hidden md:block">
                <button
