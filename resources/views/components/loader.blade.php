<div class="loader ">
  <div class="px-5 lg:px-32">
    <div class="block text-purple-600">
      <svg class="block w-16 mx-auto" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
    ...
    <h1 class="mt-4 text-lg font-bold text-center text-black/90 lg:text-3xl">
      <span class="question"></span>
      <br>
      <span class="text-blue-400 answer">...</span>
    </h1>
    <div class="block mx-auto lds-ellipsis">
      <div></div>
      <div></div>
      <div></div>
    </div>
