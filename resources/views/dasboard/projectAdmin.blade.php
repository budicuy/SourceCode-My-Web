                ...
                <table class="w-full py-5 text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                <img class="max-w-[100px] mx-auto rounded-full"
                                    src="{{ asset('img/project/'. $project->image) }}" alt="">
                            </td>
                            <th scope="row"
                            ...
                            <td class="px-6 py-4 ">
                                <div class="flex gap-3">
                                    <a href="#"
                                        class="px-5 py-2 font-medium text-white bg-blue-600 rounded-lg hover:opacity-75">Edit</a>
                                    <a href="#"
                                        class="px-5 py-2 font-medium text-white bg-red-600 rounded-lg hover:opacity-75">Delete</a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
